...
CPP = g++
CPP_FLAGS = -isystem$(INCLUDE_DIR) -I$(SHADERS) -I$(SRC_DIR) -MMD -MP -std=c++14 -g  -Wno-sign-compare -D_WEBSOCKETPP_CPP11_THREAD_ -DCURL_STATICLIB -isystem"D:\OpenSSL-Win64\include" -isystem"include/sleepy_discord/IncludeNonexistent"
LINKER_FLAGS = -L$(LIB_DIR) -L"D:\OpenSSL-Win64\lib" -lopencv_core411 -lopencv_imgcodecs411 -lopencv_highgui411 -lopencv_xfeatures2d411 -lopencv_features2d411 -lopencv_imgproc411 -lsfml-graphics -lsfml-window -lsfml-system -lopengl32 -lgdi32 -lgdiplus -lole32 -lsleepy-discord -lcpr -lcurl -lssl -lcrypto -lcrypt32 -lpthread -lws2_32 -lWldap32
