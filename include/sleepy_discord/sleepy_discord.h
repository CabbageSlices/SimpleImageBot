...
1. sleepy_c++_discord_library.h is an awful library name, consider using something a bit more sane like sleepy_discord.hpp or
something.
...
That's a pretty bad way of passing data. I guess if it's written in C it makes sense but you should have written a thin
wrapper in C++ for it
